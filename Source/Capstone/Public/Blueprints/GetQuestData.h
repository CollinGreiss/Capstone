...
#include "GetQuestData.generated.h"


UCLASS()
class CAPSTONE_API UGetQuestData : public UBlueprintAsyncActionBase {
...
public:
    ...
    static UGetQuestData* GetQuestData( UObject* WorldContextObject, const FString& QuestName );
