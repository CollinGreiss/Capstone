...
#include "UpdatePlayerDataById.generated.h"

UCLASS()
class CAPSTONE_API UUpdatePlayerDataById : public UBlueprintAsyncActionBase {
...
public:
    ...
    static UUpdatePlayerDataById* UpdatePlayerDataById( UObject* WorldContextObject, const FPlayerData& PlayerData );
