...
#include "GetPlayerDataById.generated.h"

UCLASS()
class CAPSTONE_API UGetPlayerDataById : public UBlueprintAsyncActionBase {
...
public:
    ...
    static UGetPlayerDataById* GetPlayerDataById( UObject* WorldContextObject, int32 PlayerId );
