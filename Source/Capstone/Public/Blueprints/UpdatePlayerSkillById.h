...
#include "UpdatePlayerSkillById.generated.h"

UCLASS()
class CAPSTONE_API UUpdatePlayerSkillById : public UBlueprintAsyncActionBase {
...
public:
    ...
    static UUpdatePlayerSkillById* UpdatePlayerSkillById( UObject* WorldContextObject, const FPlayerSkillData& PlayerSkillData );
